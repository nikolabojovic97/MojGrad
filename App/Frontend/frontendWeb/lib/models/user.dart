class User {
  ...
  double reportValidity;

  bool selected = false;

  User(this.username, this.name, this.email, this.password, this.imgUrl, this.bio, this.city, this.phone, this.token, this.roleID) {
    this.isVerify = false;
    this.isVerifyInstitution = false;
  }

  double reportValidityRounded() {
    return reportValidity.roundToDouble();
  }
  ...
  User.fromJSON(dynamic json){
    ...
    this.reportValidity = json["reportValidity"];
  }
}