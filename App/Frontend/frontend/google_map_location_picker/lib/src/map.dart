...
import 'package:google_map_location_picker/src/utils/cyrillicConverter.dart';
                  ...
                  Flexible(
                    ...
                    child: FutureLoadingBuilder<String>(
                        ...
                        builder: (context, address) {
                          _address = address;
                          return Text(
                            address ?? 'Nema adrese na ovoj lokaciji.',
    ...
    return IgnorePointer(
      child: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: <Widget>[
            Icon(Icons.place, size: 56, color: Colors.lightGreen.withOpacity(0.9),),
            Container(
