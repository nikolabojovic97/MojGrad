...
namespace backApp.Controllers
{
    [Route("[controller]")]
    [ApiController]
    public class RHCPController : ControllerBase
    {
        private readonly bazaContext _context;

        public RHCPController(bazaContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Users
        [HttpGet]
        public async Task<ActionResult<IEnumerable<RHCP>>> GetRHCP()
        {
            return await _context.RHCP.ToListAsync();
        }
